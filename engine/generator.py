    ...
    # ── HEART/EGO ──
        ...
        wb.programmed = [
            ("Your value to society is measured by your income, title, and output.",
             ...
             [
                 ("If I'm not earning well, I must not be providing value.",
                  "Earnings reflect monetization, and my worth exists independently of revenue."),
                 ("I need an impressive title to be taken seriously.",
                  "I am taken seriously because of what I bring to the room. My presence is my title."),
                 ("My LinkedIn or resume should tell a coherent, linear success story.",
                  "My story is a constellation where every point contributed to my current capacity."),
             ]),
            ("Real adults have stable careers, retirement plans, and consistent trajectories.",
             ...
             [
                 ("I should have figured out my career by now.",
                  "I figure out my next step. Life reveals itself incrementally, and I am on track for a life that is mine."),
                 ("Not having a clear 5-year plan means I'm directionless.",
                  "My direction is guided by recognition and invitation, responding to life as it presents itself."),
            ...
            ("Willpower is a muscle — if yours is weak, you just need to train it harder.",
             f"When I am correctly invited and recognized, my will engages effortlessly through alignment.",
             [
        ...
        wb.inherited = [
            ("In my family, your worth was measured by your paycheck — if you weren't earning, you weren't contributing.",
             "I measure contribution by impact, presence, and the quality of what I bring.",
             [
                 ...
                 ("Money worries are genetic — I inherited financial anxiety and can't escape it.",
                  "I inherited financial patterns that I can learn to transform into new relationships with money."),
            ...
            ("We come from humble people — reaching above your station brings shame and failure.",
             ...
             [
                 ("Wanting more than my parents had is ungrateful.",
                  "Wanting more is wanting to expand the legacy. Achieving more fulfills the hopes of those who came before me."),
            ...
            ("You don't get to rest until you've made it — and most of us never make it.",
             ...
             [
                 ("Rest is a reward for the successful — I haven't earned it yet.",
                  "Rest is the fuel for success. I rest now because the next stage requires a full tank."),
                 ...
                 ("If I stop pushing, I'll slide back into poverty or obscurity.",
                  "I am on a path where resting consolidates forward progress. I can pause without losing ground."),
             ]),
        ]
    ...
    # ── SPLEEN ──
            ...
            ("I am fundamentally unsafe — the world is dangerous and I am unprotected.",
             ...
             [
                 ...
                 ("People who feel safe are naive — I see what they don't see.",
                  "People who feel safe have different conditioning, and my hyper-vigilance is a learned pattern."),
             ]),
            ...
            ("I absorb everyone's fear and anxiety — I'm an emotional sponge with no protection.",
             ...
             [
                 ...
                 ("I have to avoid anxious people or I'll be contaminated.",
                  "I maintain my internal boundary and can be present with someone in distress without absorbing their distress."),
        ...
        wb.programmed = [
            ...
            ("If you're not worried, you're not paying attention.",
             "When I am present, I am calm and clear. True attention is peaceful.",
             [
                 ...
                 ("The responsible people are the ones who worry.",
                  "The responsible people are the ones who act. I can be responsible while feeling calm."),
            ...
            ("Trust must be earned slowly — people are dangerous until proven safe.",
             ...
             [
                 ...
                 ("I've been betrayed before — I won't let it happen again.",
                  "I was betrayed because someone made a choice. I keep my heart open and my boundaries clear."),
            ...
            ("My family survived by being suspicious of outsiders — trust the family, question everyone else.",
             ...
             [
                 ...
                 ("Blood is the only bond you can truly trust.",
                  "Trust is built through consistency, presence, and integrity. I hold both blood bonds and chosen bonds."),
             ]),
            ("There is always a hidden danger — my grandmother survived by never letting her guard down.",
             "My grandmother survived by staying vigilant, and that strategy served her time. I live in a world where I can lower my guard and still be safe.",
             [
                 ...
                 ("Lowering my guard means forgetting what they went through.",
                  "Lowering my guard means I am free in ways my ancestors sacrificed for me to become."),
            ...
            ("I don't know who I am — I have no fixed identity.",
             ...
             [
                 ...
                 ("I'll never figure out who I really am.",
                  "I am an unfolding to be experienced, revealing new layers with each year and each connection."),
             ]),
            ("I have no direction — I don't know where I'm going in life.",
             f"My direction reveals itself through alignment and invitation, guiding me precisely where I am needed.",
             [
            ...
            ("I don't belong anywhere — I'm fundamentally out of place.",
             ...
             [
                 ...
                 ("I'll always feel like an outsider.",
                  "Feeling like an outsider is a passing sensation that shifts when I find the right spaces."),
             ]),
        ]

        wb.programmed = [
            ("You need to find your passion and pursue it relentlessly — that's how you build a meaningful life.",
             "I need alignment. My meaningful life is built through following what resonates in each season.",
             [
                 ("I should have found my 'one thing' by now.",
                  "I am a constellation whose different stars light up at different times."),
            ...
            ("You are the architect of your own life — if you're lost, you just haven't planned well enough.",
             ...
             [
                 ("If I just planned more, I'd feel less lost.",
                  "My peace comes from trusting the unfolding rather than creating rigid expectations."),
